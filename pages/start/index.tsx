...
const Home: NextPage = () => {
  return (
    <div className={styles.container}>
      ...
      <div className="relative h-full w-full justify-center background-mobile-static  overflow-auto hide-scrollbar   items-center text-center">
        {/* Hero section */}
        ...
        <div className="container mx-auto px-4 lg:py-20 md:py-6 py-0 relative">
          <div className="grid  gap-4  items-start ">
            <section className="w-full  justify-start items-center text-center">
              <embed
                src="https://blocksurvey.io/early-access-X36elCqiSfe3E6RKGAL8cw-o"
                className="w-full bg-gray-400 rounded-2xl h-[50vh]"
              />
            </section>
          </div>
        </div>
